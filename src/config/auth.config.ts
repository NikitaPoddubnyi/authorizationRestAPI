...
export function getAuthConfig(
	...
	return {
		accessTokenExp: configService.getOrThrow<string>('JWT_ACCESS_TOKEN_EXPIRATION_TIME'),
		refreshTokenExp: configService.getOrThrow<string>('JWT_REFRESH_TOKEN_EXPIRATION_TIME'),
